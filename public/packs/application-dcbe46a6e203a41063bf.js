...
var map = {
	...
	"./time_localizer_controller.js": 36
};
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function sort_options_by_time() {
      ...
      console.log(_typeof(sorted_options[0]));
      console.log(_typeof(sorted_options[0].outerHTML));
      this.element.innerHTML = sorted_options.map(function (x) {
        return x.outerHTML;
      });
      // $("#user_email_time_of_day").html(sorted_options)
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-dcbe46a6e203a41063bf.js.map