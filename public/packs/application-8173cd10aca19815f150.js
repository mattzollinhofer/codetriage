...
throw new Error("Module build failed: SyntaxError: \"target\" is read-only\n\n  16 |     const target = event.target;\n  17 |     if (target == document){\n> 18 |       target = this.tabTarget\n     |       ^\n  19 |     }\n  20 |     this.tabTargets.forEach((el, i) => {\n  21 |       // this.data.set(\"activated\", false)\n");

/***/ })
/******/ ]);
//# sourceMappingURL=application-8173cd10aca19815f150.js.map