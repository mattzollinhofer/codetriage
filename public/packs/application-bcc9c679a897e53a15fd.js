...
var map = {
	"./language_filter_controller.js": 34,
	"./tabs_controller.js": 35
};
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function toggleFilter() {
      this.filterTarget.classList.toggle("hide");
    }
  }, {
    key: "chooseLanguage",
    value: function chooseLanguage() {
      // debugger
      event.preventDefault();

      var language = event.currentTarget.dataset.language;
      // debugger
      this.filterTarget.textContent = language;
      $(".xtypes-filter-button").html(language);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-bcc9c679a897e53a15fd.js.map